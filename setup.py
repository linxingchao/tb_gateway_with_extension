...
setup(
    ...
    packages=['thingsboard_gateway', 'thingsboard_gateway.gateway', 'thingsboard_gateway.storage',
              ...
              'thingsboard_gateway.connectors.rest', 'thingsboard_gateway.connectors.snmp','thingsboard_gateway.connectors.s7',
              ...
              'thingsboard_gateway.extensions.rest',  'thingsboard_gateway.extensions.snmp','thingsboard_gateway.extensions.s7'
              ],
    install_requires=[
        'jsonpath-rw',
        #'regex',
